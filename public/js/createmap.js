...
$('.aside ul').on('click', 'li', function () {
    //if the block is already selected in the ul list;
    if ($(this).attr('class').indexOf('act') >= 0) {
        ...
        //if the block is not selected in the ul list;
        $(this).addClass('act');
...
layui.use(['form', 'layedit', 'laydate'], function () {
    ...
    // current
    //var datas = [{ "id": 0, "asideName": ".asideitem aside1 act", "boxName": ".drag1Wrap", "soName": "1", "pageX": 0, "pageY": 0 }]
